...
<body class="cbp-spmenu-push">
	...
	<div class="container-fluid">
		...
		<!--FIRST-->
			...
			<!--FEED POST-->
			<div class="panel panel-default" id="viewsBuddyContainer">
			  <div class="panel-heading">
			  <ul class="nav nav-tabs nav-justified">
						<li class="active"><a href="#addBuddy" data-toggle="tab">Add Buddy</a></li>
						<li class=""><a href="#myBuddies" data-toggle="tab">My Buddies <span id="noOfBuddies" class="badge">-</span></a></li>
						<li class=""><a href="#request" data-toggle="tab">Request <span id="noOfRequest" class="badge">-</span></a></li>
			  ...
			  <div class="pad-1">
				<div class="tab-content">
						<!-- Add Buddy-->
						<div class="tab-pane active" id="addBuddy">
							
						<ul class="list-group">
						  <li class="list-group-item active">People You May Know(Send Request)</li>
						  <div id="membersContainer">Loading.....</div>
						  <li class="list-group-item "><a href="#top" id="showNextMembers" class="btn btn-block btn-primary ">Load More</a></li>
						</ul>
						</div>
						
						
						<!-- My Buddies -->
						<div class="tab-pane" id="myBuddies">
							<ul class="list-group">
						  <li class="list-group-item active">Your Buddies</li>
						  <div id="myBuddiesContainer">Loading.....</div>
						...
						<div class="tab-pane" id="request">
							<ul class="list-group">
						  <li class="list-group-item active">Friend Request</li>
						  <div id="myBuddyRequestContainer">Loading.....</div>
						</ul>
			...
			<!-- DIRECT CHAT PRIMARY -->
					  <div class="box box-primary direct-chat direct-chat-primary">
						...
						<div class="box-body">
							<div class="direct-chat-messages" id="chatContainer">Loading Chat....</div>
						</div>
						...
						<div class="box-footer">
							...
							<div class="input-group">
							  <input onkeyup="checkChar('sendMessageText')" maxlength ="249" type="text" id="sendMessageText" name="message" placeholder="Type Message ..." class="form-control">
	...
	<div id="pageInfo" class="hidden">buddiesPage</div>
		...
		<!--script src="js/buddiesJquery.js"></script>	
		<script src="js/buddiesFunctions.js"></script-->
